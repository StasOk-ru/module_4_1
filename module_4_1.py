...
# Высшая же математика опровергает это и говорит,
...
# Создайте модуль module_4_1 (если ещё не создан), импортируйте в него функции divide
...
# Запустите эти функции в модуле module_4_1,
